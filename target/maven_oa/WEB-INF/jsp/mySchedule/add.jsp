	...
	<div class="layui-fluid">
		<div class="layui-row">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					<label for="L_begin_time" class="layui-form-label"> <span
						class="x-red">*</span>开始时间
					</label>
					<div class="layui-input-inline">
						<input type="text" id="L_begin_time" name="begin_time" required=""
							placeholder="请输入开始时间" lay-verify="begin_time" autocomplete="off" readonly="readonly"
							class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="L_end_time" class="layui-form-label"> <span
						class="x-red">*</span>结束时间
					</label>
					<div class="layui-input-inline">
						<input type="text" id="L_end_time" name="end_time" required=""
							placeholder="请输入结束时间" lay-verify="end_time" autocomplete="off" readonly="readonly"
							class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
