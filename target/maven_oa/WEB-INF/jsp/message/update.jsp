		...
		<div class="layui-row">
			<form class="layui-form">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_id" name="id" required=""
							placeholder="请输入编号" lay-verify="id" value="${message.id }"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_name" name="title" value="${message.title }"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_content" name="content" value="${message.content }"
				...
				<div class="layui-form-item">
					<label for="messtype.id" class="layui-form-label"> <span
						class="x-red">*</span>消息类型
					</label>
					<div class="layui-input-inline">
						<c:forEach items="${messtypes }"  var="messtype">
						<c:if test="${message.messtype.id eq messtype.id }">
						<input type="radio"  name="messtype.id"  value="${messtype.id }"  title="${messtype.type }"  checked="checked"/>
						</c:if>
						<c:if test="${message.messtype.id ne messtype.id }"></c:if>
							<input type="radio"  name="messtype.id"  value="${messtype.id }"  title="${messtype.type }"  />
						</c:forEach>
					</div>
				</div>
